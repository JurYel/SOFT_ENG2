...
urlpatterns = [
    ...
    path('visualization/', include([
        ...
        path('ecommerce/', include([
            path('lazada/', include([
                path('data/', views.EcommerceLazadaData.as_view(), name='ecommerce-lazada'),
                path('data/id=<int:pk>/', views.EcommerceLazadaData.as_view(), name='ecommerce-lazada-id')
            ])),
            path('shopee/', include([
                path('data/', views.EcommerceShopeeData.as_view(), name='ecommerce-shopee'),
                path('data/id=<int:pk>', views.EcommerceShopeeData.as_view(), name='ecommerce-shopee-id')
            ])),
        ])),
    ])),   
]